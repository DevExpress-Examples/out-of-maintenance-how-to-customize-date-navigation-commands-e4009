...
public class CustomNavigateForwardCallbackCommand : NavigateForwardCallbackCommand {
    ...
    protected override void ExecuteCore() {
        this.Control.Start = this.Control.ActiveView.GetVisibleIntervals().End;
    }
}
...
public class CustomNavigateBackwardCallbackCommand : NavigateBackwardCallbackCommand {
    ...
    protected override void ExecuteCore() {
        ...
        this.Control.Start = this.Control.ActiveView.GetVisibleIntervals().Start.AddHours(-duration.TotalHours);
    }
}