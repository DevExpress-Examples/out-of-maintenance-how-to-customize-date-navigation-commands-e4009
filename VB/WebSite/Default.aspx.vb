...
Public Class CustomNavigateForwardCallbackCommand
	...
	Protected Overrides Sub ExecuteCore()
		Me.Control.Start = Me.Control.ActiveView.GetVisibleIntervals().End
	End Sub
End Class
...
Public Class CustomNavigateBackwardCallbackCommand
	...
	Protected Overrides Sub ExecuteCore()
		...
		Me.Control.Start = Me.Control.ActiveView.GetVisibleIntervals().Start.AddHours(-duration.TotalHours)
	End Sub
End Class